...
def main():
    ...
    st.image(img2)
    st.write("البحث عن المفقودين من خلال استخدام الطائرات بدون طيار،تمتاز هذه الطائرات بالقدرة على تحديد المواقع بدقة، وتوفير صور مباشرة، والتنقل بفعالية في المناطق الصعبة, مما يتيح لفرق البحث والإنقاذ الحصول على معلومات دقيقة وفورية حول المناطق المستهدفة وضحايا الحوادث.")
